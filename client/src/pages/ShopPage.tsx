...
const ShopPage = () => {
  ...
  if (shopsLoading)
    return (
      <div className="flex justify-center py-20 animate-pulse text-orange-500 font-bold">
        Loading Shops...
      </div>
    );
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((cat) => (
                <Button
                  ...
                  className="rounded-full px-4 py-1.5 text-xs h-auto"
                >
                  {cat}
                </Button>
              ))}
        ...
        {selectedShopId ? (
          <>
            ...
            <div ref={ref} className="py-12 flex justify-center h-24 mt-6">
              {productsLoading && (
                <div className="text-orange-500 animate-bounce">...</div>
              )}
            </div>
          </>
        ) : (
